...
| r | Resets the board
| ctrl + s | Save the current state of the board as a *.json (may need to click back on the board)
| ctrl + l | Loads a board state from a *.json (may need to click back on the board)
